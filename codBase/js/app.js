...
var calculadora = {
  init: function(){
    ...
    //Eventos para las teclas especiales
    ...
    multi.addEventListener("mousedown",function(){
      multi.setAttribute("style", "transform:scale(0.95,0.95)")
    })
